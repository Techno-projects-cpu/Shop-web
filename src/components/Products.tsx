...
export function Products() {
  ...
  return (
    <section id="products" className="bg-pine-900/40 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
          {visible.map((p, i) => (
            <Reveal key={p.title} delay={(i % 3) * 80}>
              <article className="group flex h-full flex-col rounded-3xl border border-paper-100/10 bg-pine-900 p-7 transition duration-300 hover:-translate-y-1 hover:border-water-500/40 hover:shadow-lift">
                ...
                <a
                  href="#contact"
                  className="mt-auto inline-flex items-center gap-2 pt-6 text-sm font-semibold text-leaf-300 transition hover:text-leaf-200"
                >
        ...
        <Reveal delay={120} className="mt-12">
          <div className="relative overflow-hidden rounded-3xl border border-paper-100/10">
            ...
            <div className="absolute inset-0 flex flex-col justify-center gap-3 p-8 sm:p-10">
